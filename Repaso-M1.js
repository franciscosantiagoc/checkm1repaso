...
var countProps = function(obj) {
  // Tu código aca:
  var count = 0;
  for(var property in obj){  //for(var i=0; condicion; i++)
    count++;
...
// Implementar el método changeNotNumberzs dentro del prototype de LinkedList que deberá cambiar
...
LinkedList.prototype.changeNotNumbers = function(pos){
  // Tu código aca:
  var changes = 0;
